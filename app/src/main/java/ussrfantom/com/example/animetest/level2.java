...
public class level2 extends AppCompatActivity {
    ...
    //код скругляющий углы у картинки
        ...
        dialog.setContentView(R.layout.previewdialog21);//<---------------------------------------------
        ...
        buttoncontinue2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                try {
                    Intent intet = new Intent(level2.this, level3.class);
                    startActivity(intet);
                    finish();
                }catch (Exception e){
        ...
        buttoncontinue3.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                try {
                    Intent intet = new Intent(level2.this, LevelsActivity.class);
                    startActivity(intet);
                    finish();
                }catch (Exception e){
