...
public class level8 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        text_levels.setText(R.string.level_8);  //<-----------------------------------------------
    ...
    //код скругляющий углы у картинки
        ...
        dialog.setContentView(R.layout.previewdialog81);//<---------------------------------------------
        ...
        dialogEnd.setContentView(R.layout.dialogend8);//<---------------------------------------------
        ...
        buttoncontinue2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                try {
                    Intent intet = new Intent(level8.this, level9.class);
                    startActivity(intet);
                    finish();
                }catch (Exception e){
        ...
        buttoncontinue3.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                try {
                    Intent intet = new Intent(level8.this, LevelsActivity.class);
                    startActivity(intet);
                    finish();
                }catch (Exception e){
